...
import { Mail, KeyRound, User, CheckCircle } from "lucide-react";
  ...
  return (
    <Card className="w-full max-w-md shadow-xl">
      <CardHeader className="text-center">
        ...
        <CardDescription>Join Yucca and start managing your plants smartly.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
        ...
        <Button variant="outline" className="w-full" onClick={() => alert("Gmail Sign-Up (Not Implemented)")}>
