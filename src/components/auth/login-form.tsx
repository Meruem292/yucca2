  ...
  return (
    <Card className="w-full max-w-md shadow-xl">
      <CardHeader className="text-center">
        ...
        <CardDescription>Sign in to access your Yucca dashboard.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
        ...
        <Button variant="outline" className="w-full" onClick={() => alert("Gmail Sign-In (Not Implemented)")}>
